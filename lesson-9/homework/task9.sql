...
SELECT Customers.FirstName + 'A' + Customers.LastName AS CustomerName, Orders.OrderID
FROM Orders
INNER JOIN Customers ON Orders.CustomerID = Customers.CustomerID

SELECT Students.Name AS StudentName, Courses.CourseID, Courses.CourseName
FROM Students
CROSS JOIN Courses
...
SELECT Customers.FirstName + 'a' + Customers.LastName AS CustomerName
FROM Customers
LEFT JOIN Orders ON Customers.CustomerID = Orders.CustomerID
WHERE Orders.OrderID IS NULL

SELECT Orders.OrderID, Customers.FirstName + 'a' + Customers.LastName AS CustomerName, Products.ProductName, Products.Price
FROM Orders
INNER JOIN Customers ON Orders.CustomerID = Customers.CustomerID
INNER JOIN Products ON Orders.ProductID = Products.ProductID
...
SELECT Customers.FirstName + 'e' + Customers.LastName AS CustomerName, Orders.OrderID, Payments.Amount
FROM Orders
INNER JOIN Customers ON Orders.CustomerID = Customers.CustomerID
...
SELECT Products.ProductName, COUNT(Orders.OrderID) AS TotalOrders
FROM Products
LEFT JOIN Orders ON Products.ProductID = Orders.ProductID
GROUP BY Products.ProductName

SELECT Customers.FirstName + 'e' + Customers.LastName AS CustomerName, SUM(Payments.Amount) AS TotalPayment
FROM Customers
...
SELECT Products.ProductName, SUM(Products.Price) AS TotalSales
FROM Products
INNER JOIN Orders ON Products.ProductID = Orders.ProductID
GROUP BY Products.ProductName
...
SELECT Students.Name AS StudentName, COUNT(Enrollments.CourseID) AS TotalCourses
FROM Students
INNER JOIN Enrollments ON Students.StudentID = Enrollments.StudentID
GROUP BY Students.Name


SELECT TOP 1 Customers.FirstName + 'O' + Customers.LastName AS CustomerName, SUM(Payments.Amount) AS TotalPaid
FROM Customers
INNER JOIN Orders ON Customers.CustomerID = Orders.CustomerID
INNER JOIN Payments ON Orders.OrderID = Payments.OrderID
GROUP BY Customers.FirstName, Customers.LastName
...
SELECT Customers.FirstName + 'a' + Customers.LastName AS CustomerName, MAX(Orders.OrderDate) AS LastOrderDate
FROM Customers
INNER JOIN Orders ON Customers.CustomerID = Orders.CustomerID
GROUP BY Customers.FirstName, Customers.LastName
...
SELECT Customers.FirstName + 'a' + Customers.LastName AS CustomerName, SUM(Payments.Amount) AS TotalPayment
FROM Customers
INNER JOIN Orders ON Customers.CustomerID = Orders.CustomerID
